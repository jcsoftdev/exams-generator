...
const MATH_IDENTIFIERS = new Set([
  ...
  "sin", "sen", "cos", "tan", "tg", "ctg", "sec", "csc", "cot", "sinh", "cosh", "tanh",
  "arcsin", "arcsen", "arccos", "arctan", "arcsec", "arccsc", "arccot",
  // analysis
  "log", "ln", "lg", "exp", "lim", "limsup", "liminf", "sup", "inf", "sum", "prod",
  "int", "integral", "oint", "diff", "dif", "partial",
  // constructors
  "sqrt", "root", "frac", "binom", "vec", "mat", "cases", "abs", "norm", "floor", "ceil",
  "overline", "underline", "hat", "bar", "tilde", "arrow", "arrows", "harpoon", "text",
  "upright", "italic", "bold", "display", "inline", "mod", "det", "dim", "ker", "deg",
  "gcd", "lcm", "max", "min",
  // operators and relations
  "cdot", "dot", "dots", "times", "div", "plus", "minus", "circle", "star",
  "approx", "equiv", "prop", "perp", "parallel", "angle", "degree", "triangle", "square",
  // sets and logic
  "in", "nin", "subset", "supset", "subseteq", "supseteq", "union", "sect", "inter",
  "emptyset", "nothing", "forall", "exists", "and", "or", "not", "if", "otherwise",
  "infinity", "oo",
  // greek
  "alpha", "beta", "gamma", "delta", "epsilon", "zeta", "eta", "theta", "iota", "kappa",
  "lambda", "mu", "nu", "xi", "omicron", "pi", "rho", "sigma", "tau", "upsilon", "phi",
  "chi", "psi", "omega",
  "Alpha", "Beta", "Gamma", "Delta", "Epsilon", "Theta", "Lambda", "Xi", "Pi", "Sigma",
  "Upsilon", "Phi", "Psi", "Omega",
  // spacing
  "space", "quad", "thick", "thin", "med", "wide",
]);
